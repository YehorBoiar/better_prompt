...
export function stripDevIcons(isDev: boolean) {
  ...
  return {
    ...
    renderStart(outputOptions: any, inputOptions: any) {
      ...
      fs.rm(resolve(outDir, "logo-32.png"), () =>
        console.log(`Deleted logo-32.png from prod build`),
      );
      fs.rm(resolve(outDir, "logo-128.png"), () =>
        console.log(`Deleted logo-128.png from prod build`),
      );
    },
  };
}
